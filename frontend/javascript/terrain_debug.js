...
$wasmImports$$ = {__cxa_throw:($JSCompiler_StaticMethods_init$self$jscomp$inline_241_ptr$jscomp$3$$, $type$jscomp$170$$, $destructor$jscomp$2$$) => {
  ...
  $whenDependentTypesAreResolved$$([$rawType$jscomp$3$$, $rawPointerType$$, $rawConstPointerType$$], $baseClassRawType$$ ? [$baseClassRawType$$] : [], $base$jscomp$3_constructor$jscomp$1$$ => {
    ...
    if ($registeredClass$jscomp$1$$.$baseClass$) {
      var $$jscomp$logical$assign$tmpm512361819$4_pointerConverter$$;
      ($$jscomp$logical$assign$tmpm512361819$4_pointerConverter$$ = $registeredClass$jscomp$1$$.$baseClass$).$__derivedClasses$ ?? ($$jscomp$logical$assign$tmpm512361819$4_pointerConverter$$.$__derivedClasses$ = []);
    ...
    $$jscomp$logical$assign$tmpm512361819$4_pointerConverter$$ = new $RegisteredPointer$$($name$jscomp$109$$ + "*", $registeredClass$jscomp$1$$, !1, !1, !1);
    $basePrototype_constPointerConverter$$ = new $RegisteredPointer$$($name$jscomp$109$$ + " const*", $registeredClass$jscomp$1$$, !1, !0, !1);
    $registeredPointers$$[$rawType$jscomp$3$$] = {pointerType:$$jscomp$logical$assign$tmpm512361819$4_pointerConverter$$, $constPointerType$:$basePrototype_constPointerConverter$$};
    $replacePublicSymbol$$($legalFunctionName$$, $base$jscomp$3_constructor$jscomp$1$$);
    return [$baseClass$jscomp$1_referenceConverter$$, $$jscomp$logical$assign$tmpm512361819$4_pointerConverter$$, $basePrototype_constPointerConverter$$];
  });
