...
var ASM_CONSTS = {
  101280: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 101331: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 101395: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 101465: ($0) => { console.log('FPS: ' + $0); }
};
