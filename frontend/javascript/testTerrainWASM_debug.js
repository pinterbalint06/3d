...
var ASM_CONSTS = {
  102632: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 102683: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 102747: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 102817: ($0) => { console.log('FPS: ' + $0); }
};
