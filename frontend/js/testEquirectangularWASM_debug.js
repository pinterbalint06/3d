...
var ASM_CONSTS = {
  88496: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 88547: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 88611: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 88681: ($0) => { console.log('FPS: ' + $0); }
};
