...
var ASM_CONSTS = {
  102136: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 102187: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 102251: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 102321: ($0) => { console.log('FPS: ' + $0); }
};
