...
var ASM_CONSTS = {
  96848: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 96899: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 96963: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97033: ($0) => { console.log('FPS: ' + $0); }
};
