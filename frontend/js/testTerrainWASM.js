...
var ASM_CONSTS = {
  102416: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 102467: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 102531: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 102601: ($0) => { console.log('FPS: ' + $0); }
};
