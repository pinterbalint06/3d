...
var ASM_CONSTS = {
  111232: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 111283: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 111347: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 111417: ($0) => { console.log('FPS: ' + $0); }
};
