...
var ASM_CONSTS = {
  103488: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 103539: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 103603: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 103673: ($0) => { console.log('FPS: ' + $0); }
};
