...
var ASM_CONSTS = {
  102208: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 102259: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 102323: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 102393: ($0) => { console.log('FPS: ' + $0); }
};
