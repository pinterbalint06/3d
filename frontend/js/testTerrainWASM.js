...
var ASM_CONSTS = {
  96800: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 96851: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 96915: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 96985: ($0) => { console.log('FPS: ' + $0); }
};
