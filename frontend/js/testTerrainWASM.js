...
var ASM_CONSTS = {
  88928: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 88979: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 89043: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 89113: ($0) => { console.log('FPS: ' + $0); }
};
