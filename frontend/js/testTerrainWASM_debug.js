...
var ASM_CONSTS = {
  97696: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 97747: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 97811: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 97881: ($0) => { console.log('FPS: ' + $0); }
};
