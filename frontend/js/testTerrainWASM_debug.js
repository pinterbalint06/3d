...
var ASM_CONSTS = {
  88880: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 88931: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 88995: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 89065: ($0) => { console.log('FPS: ' + $0); }
};
