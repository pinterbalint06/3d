...
var ASM_CONSTS = {
  101976: () => { throw('A böngésződ nem támogatja a WebGL-t!'); },  
 102027: ($0) => { throw("Sikertelen shader fordítás: " + UTF8ToString($0)); },  
 102091: ($0) => { throw("Sikertelen shader összekapcsolás: " + UTF8ToString($0)); },  
 102161: ($0) => { console.log('FPS: ' + $0); }
};
